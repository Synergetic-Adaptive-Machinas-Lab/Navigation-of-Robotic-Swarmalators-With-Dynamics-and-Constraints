...
save('JvsRadii_unicycle.mat', 'J', 'innerRad', 'outerRad');
...
% Plot smooth lines
figure;
plot(J_fine, innerRad_smooth, 'LineWidth', 2, 'Color', [0 0.4470 0.7410]); 
hold on;
plot(J_fine, outerRad_smooth, 'LineWidth', 2, 'Color', [0.8500 0.3250 0.0980]);
% Mark original data
